...
model_directory = r'D:\Semester 5\ML'
...
if os.path.exists(model_path):
    try:
        ...
        bloodPresure = st.slider("Blood Pressure (mmHg)", min_value = 0, max_value = 122, step = 2)
        ...
        age = st.slider("Age", min_value = 21, max_value = 100, step = 1)

        input_data = [[pregnancies, glucose, bloodPresure, skinThickness, insulin, bmi,
